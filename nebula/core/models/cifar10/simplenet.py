...
class CIFAR10ModelSimpleNet(NebulaModel):
    """
    SimpleNet architecture for CIFAR-10 (simplenet_cifar_5m variant).
    ...
    Achieves 95.51% accuracy on CIFAR-10.
    ...
    def __init__(
        ...
        # SimpleNet CIFAR-10 architecture (simplenet_cifar_5m)
        # Config: (filters, stride, dropout) where "p" = pooling layer
        # Format: Conv -> BN -> ReLU (-> Dropout if specified)
