...
const ScenarioManager = (function() {
    ...
    function collectScenarioData() {
        ...
        return {
            ...
            tau: parseFloat(document.getElementById("aggTau")?.value) || 10.0,
            rtc_b: parseInt(document.getElementById("aggRtcB")?.value) || 1,
            balance_alpha: parseFloat(document.getElementById("aggBalanceAlpha")?.value) || 0.5,
            balance_gamma: parseFloat(document.getElementById("aggBalanceGamma")?.value) || 0.3,
            balance_kappa: parseFloat(document.getElementById("aggBalanceKappa")?.value) || 1.0,
